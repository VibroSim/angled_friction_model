...
console_scripts=[]
console_scripts_entrypoints = [ "%s = angled_friction_model.bin.%s:main" % (script,script.replace("-","_")) for script in console_scripts ]



setup(name="angled_friction_model",
      description="Angled friction crack heating model",
      author="Stephen D. Holland",
      version=version,
      url="http://thermal.cnde.iastate.edu",
      zip_safe=False,
      ext_modules=ext_modules,
      packages=["angled_friction_model","angled_friction_model.bin"],
      cmdclass={"install_lib": install_lib_save_version },
      package_data={"angled_friction_model": angledfrictionmodel_package_files},
